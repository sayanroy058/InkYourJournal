    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-primary to-emerald-500">
        <div className="container mx-auto text-center max-w-2xl">
          <h2 className="text-3xl font-extrabold text-white mb-4">Ready to Publish?</h2>
          <p className="text-white/80 mb-8">Submit your manuscript today and reach thousands of scientists worldwide.</p>
